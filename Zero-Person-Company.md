...
*Tu Ni — Postdoctoral Research Fellow at Harvard Business School, incoming Assistant Professor at ETH Zurich. A data scientist and operations researcher whose work fouses on experimentation in operations and the evaluation of AI solutions in enterprises. PhD in Operations Research from the National University of Singapore, M.Eng. from UC Berkeley, B.S. from Zhejiang University.*
...
Before we begin, take a look at these twenty products. They are all real, live applications you can use today. Some generate millions in revenue. Others are just getting started. All of them look and feel like professional software built by serious companies.

**Your challenge: for each one, guess whether it was built by a VC-backed company, a one-person company, or a zero-person company.**

| # | Product | What It Does |
|---|---------|-------------|
| 1 | **Gamma.app** | AI-powered presentations, docs, and websites |
| 2 | **ChatSlide.ai** | AI slides, videos, and social posts from any document |
| 3 | **Makeform.ai** | AI-native form and survey builder |
| 4 | **Jotform.com** | Online form builder with 30M+ users |
| 5 | **JotSlide.ai** | AI presentation generator from text |
| 6 | **Canva.com** | All-in-one design platform with AI features |
| 7 | **Cursor.com** | AI-first code editor |
| 8 | **Lovable.dev** | Build full-stack apps from natural language |
| 9 | **Bolt.new** | Browser-based AI app builder |
| 10 | **Midjourney** | Text-to-image AI generation |
| 11 | **PhotoAI.com** | AI-generated headshots and photos |
| 12 | **InteriorAI.com** | AI room redesign from a single photo |
| 13 | **Pika.art** | AI video generation from text and images |
| 14 | **Descript.com** | Edit video by editing text |
| 15 | **Opus Clip** | AI short-form video clips from long videos |
| 16 | **Photoroom** | AI background removal and product photos |
| 17 | **Tally.so** | Notion-like form builder |
| 18 | **Jasper.ai** | AI marketing copy and content |
| 19 | **Writesonic** | AI writing and SEO content |
| 20 | **Base44** | No-code AI app builder (acquired for $80M) |

Take a moment. Write down your guesses. Which ones have hundreds of employees and gleaming offices? Which ones are run by a single person from a laptop?

---

Here are the answers:

**VC-backed** (tens of millions to billions in funding): Gamma ($87M raised, $2.1B valuation, ~50 employees), Canva ($570M+ raised, 5,000+ employees), Cursor ($2.3B raised, $29.3B valuation), Lovable ($330M raised, $6.6B valuation), Bolt.new ($105M raised), Pika ($55M+ raised), Descript ($101M raised), Opus Clip ($50M raised, backed by SoftBank), Photoroom ($64M raised), Jasper ($131M raised).

**Bootstrapped, no VC** (but still with teams): Jotform (zero outside funding, 846 employees, ~$170M revenue), Midjourney (zero funding, ~40 employees, $200M+ revenue), ChatSlide.ai (bootstrapped, small team), Tally (bootstrapped, 5 people, $2M+ ARR), Writesonic ($2.6M, lean team).

**One person or near-zero**: Makeform.ai (one solo founder), PhotoAI (one person — Pieter Levels — $1.6M/year), InteriorAI (same solo founder), Base44 (tiny team, built in months, sold for $80M), JotSlide.ai (micro-team).

---

Now here's the part that should unsettle you.
...
Because in 2025, the marginal cost of building software collapsed to near zero. The tools that once required a 50-person engineering team — design, coding, testing, deployment, customer support, marketing copy — can now be orchestrated by AI agents that work 24 hours a day, never take vacation, and never ask for equity.

The question is no longer *"How many people do you need to build a company?"*

The question is: *"Do you need any people at all?"*
